...
type IndentApprovalStore = Record<number, ApprovalStep[]>;
...
const store: IndentApprovalStore = {
  1: [
    ...
    { stepNumber: 3, requiredRole: "gm", roleLabel: "General Manager", assignedUserName: "P. Narayan", assignedUserId: "u3", status: "approved", actionedAt: "2026-01-10T10:00:00Z", comments: "Approved. Proceed via Rate Contract RC/TGMSIDC/EQU/2025-26/0004 with M/s. Sri Srinivasa Agencies." },
  ...
  2: [
    ...
    { stepNumber: 3, requiredRole: "gm", roleLabel: "General Manager", assignedUserName: "P. Narayan", assignedUserId: "u3", status: "approved", actionedAt: "2022-10-12T14:00:00Z", comments: "Approved. Proceed via Rate Contract RC/TGMSIDC/EQU/2025-26/0005 with M/s. Green Apple Medical Systems." },
  ...
  3: [
    ...
    { stepNumber: 2, requiredRole: "biomedical_engineer", roleLabel: "Biomedical Engineer", assignedUserName: "Er. K. Srinivas", assignedUserId: "u2", status: "approved", actionedAt: "2026-01-23T11:00:00Z", comments: "Specs verified. ≥400 tests/hr, ISE module, 4°C on-board cooling, LIS interface — all conforming to TGMSIDC standard." },
    { stepNumber: 3, requiredRole: "gm", roleLabel: "General Manager", assignedUserName: "P. Narayan", assignedUserId: "u3", status: "approved", actionedAt: "2026-02-06T10:00:00Z", comments: "Approved via Rate Contract RC/TGMSIDC/EQU/2025-26/0003 (Nidek Medical India). PO to be raised." },
  ...
  4: [
    { stepNumber: 1, requiredRole: "indent_initiator", roleLabel: "Indent Initiator", assignedUserName: "Clerk A. Sharma", assignedUserId: "u1", status: "approved", actionedAt: "2025-12-15T09:00:00Z", comments: "DEXA Scanner for Endocrinology dept, Osmania General Hospital. BMD measurement, DICOM 3.0. As per TID 1A.67/TGMSIDC/EQU/2025-26." },
    ...
    { stepNumber: 3, requiredRole: "gm", roleLabel: "General Manager", assignedUserName: "P. Narayan", assignedUserId: "u3", status: "approved", actionedAt: "2025-12-28T14:00:00Z", comments: "Approved. Tender route confirmed. TID 1A.67/TGMSIDC/EQU/2025-26 initiated." },
...
export function getSteps(indentId: number): ApprovalStep[] {
  return store[indentId] ?? [];
}

export function getProgress(indentId: number): ApprovalProgress {
...
export function getActiveStepForRole(indentId: number, role: string): ApprovalStep | null {
  const steps = getSteps(indentId);
...
export function initStepsForNewIndent(indentId: number, initiatorName: string, isHighValue: boolean): ApprovalStep[] {
